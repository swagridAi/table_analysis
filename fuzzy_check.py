...
from src.visualization.network import create_network_graph
...
def main():
    ...
    # In main.py or another script
    G = create_network_graph(co_occurrence, all_elements)

    # Run fuzzy c-means clustering
    primary_communities, membership_values = detect_communities_fuzzy_cmeans(G, num_clusters=8, fuzziness=2.0)
